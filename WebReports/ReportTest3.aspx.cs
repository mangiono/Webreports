...
{
    public partial class ReportTest3 : System.Web.UI.Page
    {
        ...
        protected void btnViewReport_Click(object sender, EventArgs e)
        {
            ...
            {
                DOSStDate = null;
                Session["DOSStDateT"] = null;
            }
            else
            {
                DOSStDate = txtBoxDOSStDate.Text.ToString();
                Session["DOSStDateT"] = DOSStDate;
            }
            ...
            {
                DOSEndDate = null;
                Session["DOSEndDateT"] = null;
            }
            else
            {
                DOSEndDate = txtBoxDOSEndDate.Text.ToString();
                Session["DOSEndDateT"] = DOSEndDate;
            }
            ...
            {
                memNbr = null;
                Session["memNbrT"] = null;
            }
            else
            {
                memNbr = txtBoxMemNbr.Text.ToString();
                Session["memNbrT"] = memNbr;
            }
            ...
            Session["get_valueNLT"] = get_valueNL;
            ...
            if (radioBtnListChoose.SelectedValue == "screen")
            {
                ...
                //Response.Redirect("ReportTest3Results.aspx",false);
            }
