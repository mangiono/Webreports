...
{
    public partial class TestCreateTable : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = new DataTable("AAA_SampleDataType");
            //we create column names as per the type in DB 
            dt.Columns.Add("Sample String", typeof(string));
            dt.Columns.Add("SampleInt", typeof(Int32));
            ...
            string result = "IF OBJECT_ID(" +"'dbo."+dt.TableName+"', 'U') IS NOT NULL " + "DROP TABLE dbo." + dt.TableName + " " +BuildCreateTableScript(dt);

            //string dfdsfds = "sdfdsf";
            //return;
