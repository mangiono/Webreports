...
{
    public partial class TestDestination : System.Web.UI.Page
    {
   ...
   (TextBox)PreviousPage.FindControl("txtBoxColumns");
                ...
                cmd.Parameters["@Startymdend"].Value = dosst; // add parameters value

                cmd.Parameters.Add("@Endymdend", SqlDbType.VarChar, 8000); // add parameters with dbtype and size
                cmd.Parameters["@Endymdend"].Value = dosend; // add parameters value
