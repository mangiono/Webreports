<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="excelupload.aspx.cs" Inherits="WebReports.ExcelUploTest" %>
...
<body>
    ...
    <div>
      ...
      <asp:FileUpload ID="FileUpload1" runat="server" Height="20px" Width="530px"/>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="FileUpload1" Display="Dynamic" ErrorMessage="Please choose an excel file." ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
        <br />
        <br />
    <asp:Button ID="btnImportExcel" runat="server" OnClick="Button1_Click" Text="Attach provider data" />
        <br />
        <asp:Label ID="lblmsgdone" runat="server" Text="Label" Visible="False"></asp:Label>
        <br />
