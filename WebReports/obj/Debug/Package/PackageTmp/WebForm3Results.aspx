<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm3Results.aspx.cs" Inherits="WebReports.WebForm3Results" %>
...
<body>
    ...
    <div>
        ...
        <asp:LinkButton ID="lnkNewSearch" runat="server" PostBackUrl="~/WebForm3.aspx">New Search</asp:LinkButton>
                </td>
                <td class="auto-style1">&nbsp;</td>
                <td>
